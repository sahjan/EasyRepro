...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public static class AppReference
    {
        ...
        public static class Entity
        {
            ...
            public static string ReadOnlySubGridList = "Entity_ReadOnlySubGridList";
    ...
    public static class AppElements
    {
        public static Dictionary<string, string> Xpath = new Dictionary<string, string>()
        {
            ...
            { "Entity_ReadOnlySubGridList","//div[contains(@data-lp-id,'ReadOnlyGrid') and contains(@data-lp-id,'[NAME]')]"},
